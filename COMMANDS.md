...
**Transfers are not among them.** Who has left a club is detected from the FPL squad lists
rather than typed — see the `audit-squads` skill.
...
| Command | Scope |
|---|---|
| `-m pytest` | All 487 tests, about twelve seconds |
