...
Everything needed to take a fresh clone to a working report. If the project is already
built and you just want the page, that is the first section — the rest is the one-time
data build.

For a reference of every command and its flags, see [COMMANDS.md](COMMANDS.md). For what
the project is and why it exists, see [README.md](README.md).
